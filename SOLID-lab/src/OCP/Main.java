...
//Gaixotasunak sortu
DigestiveSymptom digestiboa = new DigestiveSymptom(1,50);
NeuroMuscularSymptom neuro = new NeuroMuscularSymptom(2,70);
RespiratorySymptom biriketakoa = new RespiratorySymptom(3,20);
CardioVascularSymptom cardio = new CardioVascularSymptom(4,30);
...
digestiboa.setAffectedDays(2);
neuro.setAffectedDays(3);
biriketakoa.setAffectedDays(4);
cardio.setAffectedDays(5);
